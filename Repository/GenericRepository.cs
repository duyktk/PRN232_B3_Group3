...
namespace Repository
{
    ...
    {
        protected PRN232_GradingSystem_APIContext _context;

        public GenericRepository()
        {
            _context ??= new PRN232_GradingSystem_APIContext();
        }

        public GenericRepository(PRN232_GradingSystem_APIContext context)
        {
            _context = context;
        }
