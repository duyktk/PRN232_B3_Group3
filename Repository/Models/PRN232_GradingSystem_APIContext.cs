...
public partial class PRN232_GradingSystem_APIContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Exam>(entity =>
        {
            ...
            entity.HasIndex(e => e.Semesterid, "IX_exam_semesterid");

            entity.HasIndex(e => e.Subjectid, "IX_exam_subjectid");
        ...
        modelBuilder.Entity<Gradedetail>(entity =>
        {
            ...
            entity.HasIndex(e => e.Gradeid, "IX_gradedetail_gradeid");
        ...
        modelBuilder.Entity<Group>(entity =>
        {
            ...
            entity.HasIndex(e => e.Createby, "IX_Group_createby");

            entity.HasIndex(e => e.Semesterid, "IX_Group_semesterid");

            entity.HasIndex(e => e.Updateby, "IX_Group_updateby");
        ...
        modelBuilder.Entity<GroupStudent>(entity =>
        {
            ...
            entity.HasIndex(e => e.Studentid, "IX_group_student_studentid");
        ...
        modelBuilder.Entity<Semester>(entity =>
        {
            ...
            entity.HasIndex(e => e.Createby, "IX_semester_createby");

            entity.HasIndex(e => e.Updateby, "IX_semester_updateby");
        ...
        modelBuilder.Entity<SemesterSubject>(entity =>
        {
            ...
            entity.HasIndex(e => e.Subjectid, "IX_semester_subject_subjectid");
        ...
        modelBuilder.Entity<Submission>(entity =>
        {
            ...
            entity.HasIndex(e => e.Examid, "IX_submission_examid");
